...
3. The player enters answers.

4. The program checks each answer and gives immediate feedback.

5. After finishing all questions, the game displays the **final quiz results**.
